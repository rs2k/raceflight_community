...
int32_t baroCalculateAltitude(void)
{
	...
	BaroAlt_tmp = (int32_t)((1.0f - powf((float)(baroPressureSum / PRESSURE_SAMPLE_COUNT) / 101325.0f, 0.190295f)) * 4433000.0f); 
    BaroAlt_tmp -= baroGroundAltitude;
	BaroAlt = (int32_t)((float)BaroAlt * barometerConfig->baro_noise_lpf + (float)BaroAlt_tmp * (1.0f - barometerConfig->baro_noise_lpf)); 
