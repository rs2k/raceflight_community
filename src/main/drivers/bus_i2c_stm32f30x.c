...
static i2cDevice_t i2cHardwareMap[] = {
    { .dev = I2C1, .scl = IO_TAG(I2C1_SCL), .sda = IO_TAG(I2C1_SDA), .rcc = RCC_APB1(I2C1), .overClock = true },
    { .dev = I2C2, .scl = IO_TAG(I2C2_SCL), .sda = IO_TAG(I2C2_SDA), .rcc = RCC_APB1(I2C2), .overClock = true }
};
...
void i2cInit(I2CDevice device)
{
 ...
 IO_t sda = IOGetByTag(i2c->sda);
    ...
    I2C_InitTypeDef i2cInit = {
        ...
        .I2C_Timing = 0x00E0257A,
    };
 if (i2c->overClock) {
        i2cInit.I2C_Timing = 0x00500E30;
    }
