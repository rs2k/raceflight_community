...
bool mma8452Detect(acc_t *acc)
{
    bool ack = false;
    uint8_t sig = 0;
    ack = i2cRead(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_WHO_AM_I, 1, &sig);
...
static inline void mma8451ConfigureInterrupt(void)
{
    ...
    gpioInit(GPIOA, &gpio);
#endif
    i2cWrite(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_CTRL_REG3, MMA8452_CTRL_REG3_IPOL);
    i2cWrite(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_CTRL_REG4, MMA8452_CTRL_REG4_INT_EN_DRDY);
    i2cWrite(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_CTRL_REG5, 0);
}
static void mma8452Init(void)
{
    i2cWrite(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_CTRL_REG1, 0);
    i2cWrite(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_XYZ_DATA_CFG, MMA8452_FS_RANGE_8G);
    i2cWrite(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_HP_FILTER_CUTOFF, MMA8452_HPF_CUTOFF_LV4);
    i2cWrite(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_CTRL_REG2, MMA8452_CTRL_REG2_MODS_HR | MMA8452_CTRL_REG2_MODS_HR << 3);
    mma8451ConfigureInterrupt();
    i2cWrite(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_CTRL_REG1, MMA8452_CTRL_REG1_LNOISE | MMA8452_CTRL_REG1_ACTIVE);
    acc_1G = 256;
}
static bool mma8452Read(int16_t *accelData)
{
    uint8_t buf[6];
    if (!i2cRead(MMA8452_I2C_INSTANCE, MMA8452_ADDRESS, MMA8452_OUT_X_MSB, 6, buf)) {
        return false;
    }
