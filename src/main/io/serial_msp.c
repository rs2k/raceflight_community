...
static const box_t boxes[CHECKBOX_ITEM_COUNT + 1] = {
    ...
    { BOXSKITZO, "SKITZO;", 12 },
    { BOXLANDING, "LANDING;", 13 },
    { BOXDELETEFLASH, "DELETE FLASH;", 14 },
    { BOXTEST1, "TEST 1;", 15 },
    { BOXTEST2, "TEST 2;", 16 },
    { BOXTEST3, "TEST 3;", 17 },
...
void mspInit(serialConfig_t *serialConfig)
{
 ...
 activeBoxIds[activeBoxIdCount++] = BOXDELETEFLASH;
...
bool processOutCommand(uint8_t cmdMSP)
{
   ...
   IS_ENABLED(IS_RC_MODE_ACTIVE(BOXDELETEFLASH)) << BOXDELETEFLASH |
