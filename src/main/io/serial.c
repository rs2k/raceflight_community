...
#endif
#if defined(USE_USART1) || defined(USE_USART2) || defined(USE_USART3) || defined(USE_USART5) || defined(USE_USART6)
...
{
#if (!defined(USE_VCP) && !defined(USE_USART1) && !defined(USE_USART2) && !defined(USE_USART3) && !defined(USE_USART5) && !defined(USE_USART6) && !defined(USE_SOFTSERIAL1) && !defined(USE_SOFTSERIAL1))
    UNUSED(callback);
    UNUSED(baudRate);
    UNUSED(mode);
    UNUSED(options);
   ...
   #ifdef STM32F4
   if (IO_TAG(USART1_RX_PIN) == IO_TAG(USART1_TX_PIN)) {
    options |= SERIAL_BIDIR;
   }
   #endif
            serialPort = uartOpen(USART1, function, callback, baudRate, mode, options);
            break;
#endif
#ifdef USE_USART2
        case SERIAL_PORT_USART2:
   #ifdef STM32F4
   if (IO_TAG(USART2_RX_PIN) == IO_TAG(USART2_TX_PIN)) {
    options |= SERIAL_BIDIR;
   }
   #endif
   serialPort = uartOpen(USART2, function, callback, baudRate, mode, options);
            break;
#endif
#ifdef USE_USART3
  case SERIAL_PORT_USART3:
   #ifdef STM32F4
   if (IO_TAG(USART3_RX_PIN) == IO_TAG(USART3_TX_PIN)) {
    options |= SERIAL_BIDIR;
   }
   #endif
   serialPort = uartOpen(USART3, function, callback, baudRate, mode, options);
   break;
#endif
#ifdef USE_USART4
        case SERIAL_PORT_USART4:
   #ifdef STM32F4
            if(IO_TAG(USART4_RX_PIN) == IO_TAG(USART4_TX_PIN)) {
                options |= SERIAL_BIDIR;
            }
   #endif
   serialPort = uartOpen(UART4, function, callback, baudRate, mode, options);
            break;
#endif
#ifdef USE_USART5
        case SERIAL_PORT_USART5:
   #ifdef STM32F4
   if (IO_TAG(USART5_RX_PIN) == IO_TAG(USART5_TX_PIN)) {
    options |= SERIAL_BIDIR;
   }
   #endif
   serialPort = uartOpen(UART5, function, callback, baudRate, mode, options);
            break;
#endif
#ifdef USE_USART6
        case SERIAL_PORT_USART6:
   #ifdef STM32F4
   if (IO_TAG(USART6_RX_PIN) == IO_TAG(USART6_TX_PIN)) {
    options |= SERIAL_BIDIR;
   }
   #endif
   serialPort = uartOpen(USART6, function, callback, baudRate, mode, options);
            break;
#endif
#ifdef USE_SOFTSERIAL1
