...
F4_TARGETS = REVO REVOLT SPARKY2 REVONANO REVONANO_VB ALIENFLIGHTF4 BLUEJAYF4 VRCORE QUANTON KKNGF4 KKNGF4_6500 HOOLIGAN PRACER

F405_TARGETS = REVO REVOLT SPARKY2 ALIENFLIGHTF4 BLUEJAYF4 VRCORE QUANTON KKNGF4 KKNGF4_6500 HOOLIGAN
F4_256K_TARGETS	 = REVO REVO_OPBL REVOLT SPARKY2 REVONANO REVONANO_VB ALIENFLIGHTF4 BLUEJAYF4 VRCORE QUANTON QUANTON_OPBL AQ32_V2 PRACER REVONANO_VBKKNGF4 KKNGF4_6500 KKNGF4 HOOLIGAN
F4_512K_TARGETS	 =
...
OPTIMIZE	 = -$(OPT)
else ifeq ($(TARGET),$(filter $(TARGET),REVO REVOLT REVONANO REVONANO_VB ALIENFLIGHTF4 BLUEJAYF4 VRCORE KKNGF4 KKNGF4_6500 HOOLIGAN PRACER))
OPTIMIZE	 = -$(OPT)
else
OPTIMIZE	 = -$(OPT)
endif
